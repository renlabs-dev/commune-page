  ...
  return (
    ...
    >
      ...
      <div className='max-w-7xl py-0 lg:px-8 lg:py-40'>
        <div className='mx-auto flex max-w-2xl flex-shrink-0 animate-fade-slide-down flex-col items-center justify-center lg:mx-0 lg:max-w-xl '>
          <div className='flex items-center'>
            <h1 className='bg-gradient-to-br from-sky-300 to-white bg-clip-text text-5xl font-bold tracking-tight text-transparent'>
              commune ai
            </h1>
          </div>
          <p className='mt-6 text-center text-xl font-extralight leading-relaxed tracking-tight text-gray-100 lg:text-center'>
