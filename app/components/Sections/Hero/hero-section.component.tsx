  ...
  return (
    ...
    >
      ...
      <div className='flex h-full w-full flex-col items-center justify-center lg:w-auto lg:items-start'>
        ...
        <Link
          href='#welcome'
          className='hover:animate-squeeze mt-8 w-full max-w-screen-sm rounded-xl border-2 border-title bg-[#FF6C6C] px-12 py-6 text-center text-sm font-bold text-title shadow-custom transition duration-300 hover:bg-[#F15B5B] lg:w-auto'
        >
