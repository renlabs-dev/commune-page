...
It is a fuzzy consensus to determine a robust agreement in a decentralized trustless setting, using stake and its submitted weights. The consensus incentive forces the collective of validators to converege to a uniform validation methodology enforcing clear order on the chaotic nature of open permissionless environment. 
