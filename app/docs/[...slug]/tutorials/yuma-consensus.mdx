...
Stake setting weights on miners is 'bonding' to them. Bonds are Stake-weight proportional ownership over the share of emissions accrued by the miner, paid out as dividends every epoch. The concept of the bond allows to modulate the incentives of validators. This is a vital component to Yuma Consensus, ensuring the robustness of the honest majority equilibrium.
