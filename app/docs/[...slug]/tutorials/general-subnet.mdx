...
This enables the protocol to incentivise things hard to represent as a mining market and allows to add specialized usecases quickly on the fly. It expands the reach of incentives towards elements like community contributions that are hard to reach with yuma subnets.
