...
To serve a Python module, ensure that it's a class inheriting from our **Module** class. Then, use our **endpoint** decorator on the methods that you want to expose as endpoints. You can refer to the [example folder](https://github.com/agicommies/communex/blob/main/src/communex/module/example) to see this being done.
