...
You can also use the CommuneX CLI

To create a wallet

```bash
comx key create <my-wallet-name>
```

Or import wallet from pre-existing mnemonic
...
```bash
comx balance transfer <from-key> <amount> <destination-ss58-addresses>
```

To stake your balance

```bash
comx balance stake <from-key> <amount> <destination-ss58-addresses>
```
