...
You can just create and serve a REST-api as you prefer. Just make sure that all your schemas look like:
```json
...
```
Beyond this, requests made with our CommuneClient will send you the following headers:
```json
