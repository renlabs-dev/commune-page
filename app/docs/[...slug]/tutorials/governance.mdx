...
Commune's voting mechanism allows stakeholders to cast votes on community proposals, with each stakeholder's voting power proportional to their stake. This system ensures that decisions are made by those who have a vested interest in the protocol's success and an increased likelyhood of understanding.
...
def add_global_proposal(
    ...
    general_params: dict[str, Any] = params
...
First go to the [Governance Page](https://governance.communeai.org/), click **New Proposal** and follow the steps to create the contents of your proposal. Copy the format and host it with an IPFS provider of your choice. For a full guidence follow [this article](https://mirror.xyz/0xD80E194aBe2d8084fAecCFfd72877e63F5822Fc5/FUvj1g9rPyVm8Ii_qLNu-IbRQPiCHkfZDLAmlP00M1Q).
After retriving the IPFS cid
