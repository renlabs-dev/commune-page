          ...
          <div className='prose flex w-full max-w-[100%] flex-col px-8 text-subtitle dark:prose-invert dark:text-gray-200 sm:max-w-[80%]  xl:max-w-[70%] 2xl:max-w-6xl'>
            <div className='relative top-10 flex w-full justify-end'>
              <Link
                ...
                className='rounded-xl border-2 border-title bg-white px-6 py-3 text-center text-sm font-medium text-title no-underline shadow-custom hover:animate-squeeze dark:border-titleDark dark:bg-transparent dark:text-titleDark dark:shadow-customDark'
              >
                <span>Edit</span>
              </Link>
            </div>
